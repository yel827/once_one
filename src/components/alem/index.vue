        ...
        <el-tab-pane label="告警列表" name="first">
          <div class="search">
            <el-form :inline="true" :model="formData" class="demo-form-inline">
              ...
              <el-select v-model="gaos2" placeholder="请选择" class="right">
                <el-option
          ...
          <el-dialog class="tanCheng" title="联系人" :visible.sync="dialogDetailsVisible" width="50%">
            <el-table :data="tableData_once" style="width: 100%">
...
export default {
  ...
  methods: {
    ...
    onSubmit_() {
      if (!(this.value || this.formInline.name || this.gaos3 || this.value2)) {
        return;
      }
      var formData = {};
      if (this.gaos3) {
        formData.source = this.gaos3;
      }
      if (this.gaos2) {
        formData.warnStatus = this.gaos2;
      }
    ...
    submit_once() {
      ...
      console.log(this.tableData_once, "once");
      let data = [];
      for (var i = 0; i < this.tableData_once.length; i++) {
        data.push(this.tableData_once[i].id);
      }
      var myMain = {
